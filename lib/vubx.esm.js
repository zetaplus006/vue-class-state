        ...
        return function (constructor) {
            return (function (_super) {
                ...
                function Vubx() {
                    ...
                    var option = __assign({ identifier: '__vubx__', root: false, strict: false, devtool: false, providers: [], plugins: [], globalPlugins: [], createdHook: ClassMetaData.get(constructor.prototype).hookMeta }, decoratorOption);
